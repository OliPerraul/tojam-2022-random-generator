...
namespace Cirrus.Unity.Editor
{
	...
	public class SerializeEmbedded : PropertyAttribute
	{
	}
#if UNITY_EDITOR
...
/// </summary>
	[CustomPropertyDrawer(typeof(SerializeEmbedded), true)]
	public class SerializeEmbeddedDrawer : PropertyDrawer
	{
		...
		public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
		{
			...
			//var buttonRect = new Rect(position.x + position.width, position.y, buttonWidth, EditorGUIUtility.singleLineHeight);
