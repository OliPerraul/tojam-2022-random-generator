...
//		public static List<Vector3> GetSpawnpoints(Bounds bounds, float radius, int seed)
//		{
//			PoissonDisc.radius = radius;
//			PoissonDisc.bounds = bounds;
...
//					Vector2 sample = _RandomPointOnAnnulus(sampleCenter);

//					if(_ValidSample(sample))
//					{
//						//Vector3 spawnPoint = CreateSpawnPoint(terrain, sample);
//						Vector3 spawnPoint = sample;
...
//						Vector2Int gridPos = _PositionToGridCoord(sample);
...
//		private static Vector2Int _PositionToGridCoord(Vector2 pos)
//		{
//			return new Vector2Int((int)(pos.x / cellSize), (int)(pos.y / cellSize));
//		}

//		private static bool _ValidSample(Vector2 sample)
//		{
//			//Reject any samples outside of the terrain bounds
//			bool valid = _InsideBounds(sample);
...
//						if(i != -1)
//						{
//							if(_OutsideRadius(sample, points[i])) return false;
//						}
//					}
//				}
//			}
...
//		private static bool _InsideBounds(Vector2 pos)
//		{
//			return (pos.x >= 0 && pos.x < bounds.size.x && pos.y >= 0 && pos.y < bounds.size.z);
//		}

//		//Check if position falls within annulus
//		private static bool _OutsideRadius(Vector2 center, Vector2 position)
//		{
//			return ((center - position).sqrMagnitude < (radius * radius));
//		}

//		private static Vector2 _RandomPointOnAnnulus(Vector2 center)
//		{
...
//		//private static Vector3 CreateSpawnPoint(Bounds t, Vector2 position)
//		//{
//		//    return new Vector3(
//		//        (position.x + (t.GetPosition().x + bounds.center.x)) - bounds.extents.x,
//		//        0f, 
//		//        (position.y + (t.GetPosition().z + bounds.center.z)) - bounds.extents.z);
//		//}
//	}
//}