...
namespace Cirrus.Collections
{
	...
	public class PairingHeap<T> : IEnumerable<T> where T : IComparable
	{
		...
		private Dictionary<T, System.Collections.Generic.List<PairingHeapNode<T>>> heapMapping
				= new Dictionary<T, System.Collections.Generic.List<PairingHeapNode<T>>>();
		...
		private void meld(PairingHeapNode<T> headNode)
		{
			...
			var passOneResult = new System.Collections.Generic.List<PairingHeapNode<T>>();
		...
		private void addMapping(T newItem, PairingHeapNode<T> newNode)
		{
			...
			{
				heapMapping[newItem] = new System.Collections.Generic.List<PairingHeapNode<T>>(new[] { newNode });
			}
		}
