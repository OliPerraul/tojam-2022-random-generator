...
namespace Cirrus.Collections
{
	...
	public class FibonacciHeap<T> : IEnumerable<T> where T : IComparable
	{
		...
		private Dictionary<T, System.Collections.Generic.List<FibonacciHeapNode<T>>> heapMapping
			= new Dictionary<T, System.Collections.Generic.List<FibonacciHeapNode<T>>>();
		...
		private void addMapping(T newItem, FibonacciHeapNode<T> newNode)
		{
			...
			{
				heapMapping[newItem] = new System.Collections.Generic.List<FibonacciHeapNode<T>>(new[] { newNode });
			}
		}
